    ...
    <div className=" flex flex-col gap-11 items-center justify-center  ">
      <div className=" flex flex-col gap-11">
        ...
        <div className="flex items-center justify-center md:justify-around flex-wrap gap-5">
          <div className="max-w-sm bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-700 via-gray-900 to-black  ">
            <div className="p-5 h-[300px] flex flex-col justify-between">
